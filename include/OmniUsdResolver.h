...
omniUsdResolverSetCheckpointMessage(const char* message) OMNIUSDRESOLVER_NOEXCEPT;

/**
 * Return a human readable string of the version of this USD resolver
 */
OMNIUSDRESOLVER_EXPORT(const char*)
omniUsdResolverGetVersionString() OMNIUSDRESOLVER_NOEXCEPT;
 ...
 */
typedef void(OMNIUSDRESOLVER_ABI* OmniUsdResolverEventCallback)(void* userData,
                                                                const char* identifier,
                                                                OmniUsdResolverEvent eventType,
                                                                OmniUsdResolverEventState eventState,
                                                                uint64_t fileSize) OMNIUSDRESOLVER_CALLBACK_NOEXCEPT;
 ...
 */
OMNIUSDRESOLVER_EXPORT(void)
omniUsdResolverUnregisterCallback(uint32_t handle) OMNIUSDRESOLVER_NOEXCEPT;
